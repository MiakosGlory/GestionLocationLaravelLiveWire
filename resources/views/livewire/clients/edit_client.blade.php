        ...
        <div class="col-md-12">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-user-plus fa-2x"></i>Modifier un Client</h3>
                </div>
                <form role="form" wire:submit.prevent="editClient">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="form-group flex-grow-1 mr-2">
                                <label>Nom</label>
                                <input type="text" class="form-control @error("editClient.nom") is-invalid 
                                @enderror" wire:model="editClient.nom">
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                <label>Prenom</label>
                                <input type="text" class="form-control @error("editClient.prenom") is-invalid 
                                @enderror" wire:model="editClient.prenom">
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                <label>Sexe</label>
                                <select class="form-control @error("editClient.sexe") is-invalid
                                 @enderror" wire:model="editClient.sexe">
                                    <option value=""></option>
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                ...
                                <input type="date" class="form-control @error("editClient.dateNaissance") is-invalid
                                 @enderror" wire:model="editClient.dateNaissance">
                        ...
                        <div class="d-flex">
                            <div class="form-group flex-grow-1 mr-2">
                                ...
                                <input type="text" class="form-control @error("editClient.lieuNaissance") is-invalid 
                                @enderror" wire:model="editClient.lieuNaissance">
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                ...
                                <input type="text" class="form-control @error("editClient.nationalite") is-invalid 
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                <label>Ville</label>
                                <input type="text" class="form-control @error("editClient.ville") is-invalid 
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                <label>Pays</label>
                                <select class="form-control @error("editClient.pays") is-invalid 
                        ...
                        <div class="d-flex">
                            <div class="form-group flex-grow-1 mr-2">
                                <label>Adresse</label>
                                <input type="text" class="form-control @error("editClient.adresse") is-invalid 
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                ...
                                <input type="text" class="form-control @error("editClient.telephone") is-invalid 
                                @enderror" wire:model="editClient.telephone">
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                ...
                                <select class="form-control @error("editClient.pieceIdentite") is-invalid 
                                @enderror" wire:model="editClient.pieceIdentite">
                                    <option value=""></option>
                            ...
                            <div class="form-group flex-grow-1 mr-2">
                                ...
                                <input type="text" class="form-control @error("editClient.numeroPieceIdentite") is-invalid 
                                @enderror" wire:model="editClient.numeroPieceIdentite">
                                @error("editClient.numeroPieceIdentite")
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        </div>
