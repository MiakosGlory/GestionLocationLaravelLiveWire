        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary d-flex align-items-center">
                    ...
                    <a href="" class="btn btn-link text-white mr-4 d-block"> <i class="fas fa-plus"></i>Ajouter Utilisateur</a>
                ...
                <div class="card-body table-responsive p-0" style="height: 300px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="tag tag-success text-center">{{$user->created_at}}</span></td>
